...
<div className="py-12 ">
  <div className="mx-auto container max-w-[228px] px-4 py-4 bg-white rounded relative">
    <p className="text-sm font-semibold leading-none text-gray-800 leading-4">Tooltip Title</p>    
    <p className=" text-xs leading-none text-gray-600 pt-2 pb-2">Tooltip Description will come here!</p>
    <div className=" pt-3 flex gap-2">
      <button className="text-xs font-medium leading-3 text-center text-indigo-700 px-3 py-2 border rounded-md border-indigo-700 w-full hover:bg-gray-100 transform duration-300 ease-in-out">Learn More</button>
      <button className="text-xs font-medium leading-3 text-center text-white px-3 py-2 bg-indigo-700 rounded-md w-full hover:bg-indigo-600 transform duration-300 ease-in-out">Got It</button>
    </div>
