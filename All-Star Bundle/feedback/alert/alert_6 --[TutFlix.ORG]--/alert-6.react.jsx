      ...
      <div className="bg-gray-200">
        <div className="px-4 py-12">
          <div className="lg:max-w-[548px] md:max-w-[516px] max-w-[319px] w-full mx-auto bg-white flex rounded-r relative">
            ...
            <div className="min-w-[4px]  bg-yellow-500" />
            <div className="px-10 py-6 ">
              <div aria-label="text">
                ...
                <p className="text-xs text-gray-600">
                  Hi, Labuschagne! We are having trouble with your current
                  billing informations. Please update your payment details.
                </p>
              </div>
              <div className="flex items-center justify-end mt-4">
                <p className="text-xs font-medium leading-3 text-yellow-700 px-3.5 py-2.5 bg-yellow-50 rounded cursor-pointer hover:underline">
                  View details
                </p>
              </div>
            </div>
